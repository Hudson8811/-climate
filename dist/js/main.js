...
document.addEventListener('DOMContentLoaded', function () {
  var form_calc = document.querySelector('#form-calculation__tabs');
  ...
  function _formsend() {
    _formsend = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var formDatastages, responsestages, result;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              formDatastages = new FormData(form_calc);
              console.log(formDatastages);
              form_calc.classList.add('_sending');
              _context.next = 6;
              return fetch('sendcalculation.php', {
                method: 'POST',
                body: formDatastages
              });

            case 6:
              responsestages = _context.sent;
...
document.addEventListener('DOMContentLoaded', function () {
  var form_hero = document.querySelector('.popap-hero__form');
  ...
  function _formsend() {
    _formsend = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var formDatahero, responsehero, result;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              formDatahero = new FormData(form_hero);
              form_hero.classList.add('_sending');
              _context.next = 5;
              return fetch('sendhero.php', {
                method: 'POST',
                body: formDatahero
              });

            case 5:
              responsehero = _context.sent;
...
document.addEventListener('DOMContentLoaded', function () {
  var form_need = document.querySelector('.popap-need__form');
  ...
  function _formsend() {
    _formsend = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var formDataneed, responseneed, result;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              formDataneed = new FormData(form_need);
              form_need.classList.add('_sending');
              _context.next = 5;
              return fetch('sendneed.php', {
                method: 'POST',
                body: formDataneed
              });

            case 5:
              responseneed = _context.sent;
    ...
    $('.faq-question').on('click', function () {
      ...
      if (!$(this).closest('li').hasClass($class)) {
        $ul.find('li').each(function () {
          if ($(this).hasClass($class)) $(this).removeClass($class).find($class_open).slideUp($speed);
        });
      }

      $answer.stop().slideToggle($speed, 'linear', function () {
        swiper2.updateAutoHeight(100);
      }).closest('li').toggleClass($class);
    });
  });
});
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function _formsend() {
    _formsend = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var formDataQuestion, responseQuestion, result;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 5;
              return fetch('sendquestion.php', {
                method: 'POST',
                body: formDataQuestion
              });

            case 5:
              responseQuestion = _context.sent;
...
/***/ "./src/blocks/modules/stages/stages.js":
/*!*********************************************!*\
  !*** ./src/blocks/modules/stages/stages.js ***!
  \*********************************************/
/***/ (function() {
...
document.addEventListener('DOMContentLoaded', function () {
  var form_stages = document.querySelector('.popap-stages__form');
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              formDatastages = new FormData(form_stages);
              form_stages.classList.add('_sending');
              _context.next = 5;
              return fetch('sendstages.php', {
                method: 'POST',
                body: formDatastages
              });
...
/* harmony import */ var _modules_stages_stages__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! %modules%/stages/stages */ "./src/blocks/modules/stages/stages.js");
/* harmony import */ var _modules_stages_stages__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_modules_stages_stages__WEBPACK_IMPORTED_MODULE_8__);
...
/*!*************************!*\
  ...
  \*************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _import_jquery_fancybox_min_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./import/jquery.fancybox.min.js */ "./src/js/import/jquery.fancybox.min.js");
/* harmony import */ var _import_jquery_fancybox_min_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_import_jquery_fancybox_min_js__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _import_script__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./import/script */ "./src/js/import/script.js");
/* harmony import */ var _import_script__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_import_script__WEBPACK_IMPORTED_MODULE_2__);
